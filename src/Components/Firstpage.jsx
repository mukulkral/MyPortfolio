...
function Firstpage({ firstPageRef, on }) {
  return (
    <>
      <div ref={firstPageRef} className={`duration-500 h-full w-full pt-40 ${on?"bg-slate-900 text-white":"bg-white"}`}>
        <div
          ...
          <div className="w-1/2 md:w-1/3 lg:w-1/3">
            ...
            <div className="text-[30px] text-center lg:text-[50px] sm:text-left md:text-left lg:text-left">
              ...
              <a href="https://github.com/mukulkral" target="_blank">
                <i class="fa-brands fa-github fa-bounce cursor-pointer hover:animate-none"></i>
              </a>
            </div>
          </div>
          <img
        ...
        <div className="flex justify-center items-center gap-4 text-[20px] sm:text-[30px] sm:gap-10 md:text-[40] lg:gap-[75px]  lg:text-[50px] flex-wrap">
          <h3 className="border-r-4 px-4 sm:text-[20px] lg:text-[30px] ">
            Tech Stack
          </h3>
